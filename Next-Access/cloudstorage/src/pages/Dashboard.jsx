...
const Dashboard = () => {
    ...
    useEffect(() => {
        const fetchRecentFiles = async () => {
            ...
            try {
                ...
                setMessage('Error loading recent files. Please check if the backend is running.');
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            const errorMsg = error.response?.data?.message || error.message || 'Error uploading files. Please try again.';
            setMessage(errorMsg);
            setMessageType('error');
        } finally {
            setUploading(false);
