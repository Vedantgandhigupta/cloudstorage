        ...
        if (location.hash) {
            ...
            if (element) {
                setTimeout(() => {
                    ...
                    // Highlight effect
                    element.classList.add('ring-4', 'ring-purple-400', 'ring-offset-2');
                    setTimeout(() => {
                        element.classList.remove('ring-4', 'ring-purple-400', 'ring-offset-2');
                    }, 3000);
                }, 100);
            }
        }
            ...
            <div className="p-6">
                ...
                <div className="mt-8 bg-gray-50 p-4 rounded-lg border border-gray-200">
                    ...
                    <p className="text-sm text-gray-600">
                        Each file upload consumes 1 credit. New users start with 50 free credits.
